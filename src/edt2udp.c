...
#define MAXINSTANCE (97)
    ...
    medconv_config_t mc_config[MAXINSTANCE] = {
      ...
      ,{61,"medconv11",0,0,"192.168.90.23","10.128.6.11"}
      ,{62,"medconv11",0,1,"192.168.90.23","10.128.6.11"}
      ,{63,"medconv11",0,2,"192.168.90.23","10.128.6.11"}
      ,{64,"medconv11",1,0,"192.168.90.24","10.128.6.11"}
      ,{65,"medconv11",1,1,"192.168.90.24","10.128.6.11"}
      ,{66,"medconv11",1,2,"127.0.0.1","10.128.6.1"}

      ,{67,"medconv12",0,0,"192.168.90.25","10.128.6.12"}
      ,{68,"medconv12",0,1,"192.168.90.25","10.128.6.12"}
      ,{69,"medconv12",0,2,"192.168.90.25","10.128.6.12"}
      ,{70,"medconv12",1,0,"192.168.90.26","10.128.6.12"}
      ,{71,"medconv12",1,1,"192.168.90.26","10.128.6.12"}
      ,{72,"medconv12",1,2,"192.168.90.26","10.128.6.12"}

      ,{85,"medconv15",0,0,"192.168.90.31","10.128.6.15"}
      ,{86,"medconv15",0,1,"192.168.90.31","10.128.6.15"}
      ,{87,"medconv15",0,2,"192.168.90.21","10.128.6.15"}
      ,{88,"medconv15",1,0,"192.168.90.32","10.128.6.15"}
      ,{89,"medconv15",1,1,"192.168.90.32","10.128.6.15"}
      ,{90,"medconv15",1,2,"192.168.90.32","10.128.6.15"}

      ,{91,"medconv16",0,0,"192.168.90.33","10.128.6.16"}
      ,{92,"medconv16",0,1,"192.168.90.33","10.128.6.16"}
      ,{93,"medconv16",0,2,"192.168.90.33","10.128.6.16"}
      ,{94,"medconv16",1,0,"192.168.90.34","10.128.6.16"}
      ,{95,"medconv16",1,1,"192.168.90.34","10.128.6.16"}
      ,{96,"medconv16",1,2,"192.168.90.34","10.128.6.16"}
    };
